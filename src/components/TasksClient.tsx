...
export default function TasksClient({ initialTasks }) {
  ...
  const handleEdit = (taskId) => router.push(`/edit_task/${taskId}`);
        ...
        {tasks.length === 0 ? (
          <div className="w-full max-w-md px-5 py-8 mx-auto text-center">
            ...
            <p className="text-gray-600 mb-4">
              Hooray! You currently have no tasks.
            </p>
            <button
            ...
            {tasks.map((task) => (
              ...
              >
                ...
                <select
                  ...
                  className={`absolute bottom-2 left-2 text-sm font-semibold border rounded-md px-2 py-1 focus:outline-none focus:ring-0 focus:ring-blue-500 ${getStatusColor(
                    task.status
                  )}`}
                >
                ...
                >
                  ...
                  >
                    <path
                      d="M10 9.75C10.4142 9.75 10.75 10.0858 10.75 10.5V16.5C10.75 16.9142 10.4142 17.25 10 17.25C9.58579 17.25 9.25 16.9142 9.25 16.5V10.5C9.25 10.0858 9.58579 9.75 10 9.75Z"
                      fill="#FF0000"
                    />
                    <path
                      d="M14.75 10.5C14.75 10.0858 14.4142 9.75 14 9.75C13.5858 9.75 13.25 10.0858 13.25 10.5V16.5C13.25 16.9142 13.5858 17.25 14 17.25C14.4142 17.25 14.75 16.9142 14.75 16.5V10.5Z"
                      fill="#FF0000"
                    />
                    <path
                      fillRule="evenodd"
